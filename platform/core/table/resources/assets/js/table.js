(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: dt => {
            return '<i class="far fa-file-excel"></i> ' + dt.i18n('buttons.excel', CmatVariables.languages.tables.excel ? CmatVariables.languages.tables.excel : 'Excel');
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: dt => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', CmatVariables.languages.tables.export ? CmatVariables.languages.tables.export : 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: dt => {
            return '<i class="fas fa-file-csv"></i> ' + dt.i18n('buttons.csv', CmatVariables.languages.tables.csv ? CmatVariables.languages.tables.csv : 'CSV');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: dt => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', CmatVariables.languages.tables.print ? CmatVariables.languages.tables.print : 'Print');
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: dt => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', CmatVariables.languages.tables.reset ? CmatVariables.languages.tables.reset : 'Reset');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: dt => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', CmatVariables.languages.tables.reload ? CmatVariables.languages.tables.reload : 'Reload');
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', event => {
                ...
                if (ids.length === 0) {
                    Cmat.showError(CmatVariables.languages.tables.please_select_record ? CmatVariables.languages.tables.please_select_record : 'Please select at least one record to perform this action!');
                    return false;
                }

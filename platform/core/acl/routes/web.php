...
use Cmat\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Cmat\ACL\Http\Controllers\Auth\LoginController;
use Cmat\ACL\Http\Controllers\Auth\ResetPasswordController;
use Cmat\ACL\Http\Controllers\UserController;

Route::group(['namespace' => 'Cmat\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {

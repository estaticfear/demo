...
All notable changes to `cmat/git-commit-checker` will be documented in this file.
...
- Fix output render on Windows platform (https://github.com/cmat/git-commit-checker/pull/10)

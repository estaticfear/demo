...
namespace Cmat\SeoHelper\Entities\Twitter;

use Cmat\SeoHelper\Contracts\Entities\MetaCollectionContract;
use Cmat\SeoHelper\Contracts\Entities\TwitterCardContract;
use Cmat\SeoHelper\Exceptions\InvalidTwitterCardException;

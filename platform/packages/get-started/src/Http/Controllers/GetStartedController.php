...
namespace Cmat\GetStarted\Http\Controllers;
...
use Cmat\GetStarted\Http\Requests\GetStartedRequest;
    ...
    public function save(GetStartedRequest $request, BaseHttpResponse $response): BaseHttpResponse
    {
        ...
        switch ($step) {
            ...
            case 2:
                ...
                if ($user->username != config('core.base.general.demo.account.username', 'cmat') &&
                    ! Hash::check($user->getAuthPassword(), config('core.base.general.demo.account.password', 'cmatwinwin'))
                ) {
                    $nextStep = 4;
                }

...
namespace Cmat\Installer\Http\Controllers;

use BaseHelper;
use Cmat\ACL\Models\User;
use Cmat\ACL\Services\ActivateUserService;
use Cmat\Installer\Events\EnvironmentSaved;
use Cmat\Installer\Events\InstallerFinished;
use Cmat\Installer\Http\Requests\SaveAccountRequest;
use Cmat\Installer\Http\Requests\SaveEnvironmentRequest;
use Cmat\Installer\Supports\EnvironmentManager;
use Cmat\Installer\Supports\RequirementsChecker;
use Carbon\Carbon;
use Exception;
use File;

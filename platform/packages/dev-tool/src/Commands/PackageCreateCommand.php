...
namespace Cmat\DevTool\Commands;

use Cmat\DevTool\Commands\Abstracts\BaseMakeCommand;
...
class PackageCreateCommand extends BaseMakeCommand
{
    public function handle(): int
    {
        ...
        $this->line(
            '<info>Add</info> <comment>"cmat/' . $package . '": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to install this package!'
        );
        $this->line('------------------');

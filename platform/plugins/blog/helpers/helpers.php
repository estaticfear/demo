...
use Cmat\Base\Supports\SortItemsWithChildrenHelper;
...
if (! function_exists('get_featured_and_other_posts_by_category')) {
    function get_featured_and_other_posts_by_category(int|string $categoryId, int $paginate = 12, int $limit = 0)
    {
        return app(PostInterface::class)->getFeaturedAndOtherPostsByCategory($categoryId, $paginate, $limit);
    }
}

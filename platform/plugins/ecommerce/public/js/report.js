    ...
    const e = t(
        {
            ...
            methods: {
                ...
                renderChart: function () {
                    ...
                    this.url &&
                        axios.get(this.url).then(function (e) {
                            e.data.error
                                ? Cmat.showError(e.data.message)
                                : ((t.earningSales = e.data.data.earningSales),
                                  (t.chart = new ApexCharts(
                                      t.$el.querySelector(
                                          ".sales-reports-chart"
                                      ),
                                      {
                                          ...
                                          xaxis: {
                                              type: "datetime",
                                              categories: e.data.data.dates,
                                          },
                                          tooltip: { x: { format: t.format } },
                                          noData: {
                                              text: CmatVariables.languages
                                                  .tables.no_data,
                                          },
                                      }
                                  )),
                ...
                clickFilter: function (t, e) {
                    ...
                    var r = this;
                    axios
                        .get(r.url, { params: { filter: t } })
                        .then(function (e) {
                            if (e.data.error) Cmat.showError(e.data.message);
                            else {
                                ...
                                e.data.data.colors &&
                                    (n.colors = e.data.data.colors),
                                    a.chart.updateOptions(n);
                            }
                            a.setFiltering(t);
                        });
                },
            ...
            mounted: function () {
                ...
                if (this.data.length) {
                    ...
                    this.data.map(function (t) {
                        ...
                        new ApexCharts(
                            this.$el.querySelector(".revenue-chart"),
                            {
                                series: e,
                                colors: a,
    ...
    vueApp.booting(function (t) {
        ...
        $(function () {
            ...
            if (window.moment && jQuery().daterangepicker) {
                ...
                i > s && (i = s);
                var l = CmatVariables.languages.reports,
                    d =
                        (n((t = {}), l.today, [s, s]),
                ...
                a.daterangepicker(
                    ...
                    function (t, r, n) {
                        $.ajax({
                            url: a.data("href"),
                            data: {
                                date_from: t.format("YYYY-MM-DD"),
                                date_to: r.format("YYYY-MM-DD"),
                                predefined_range: n,
                            },
                            type: "GET",
                            success: function (a) {
                                a.error
                                    ...
                                    : ($(".widget-item").each(function (t, e) {
                                          var r = $(e).prop("id");
                                          $("#".concat(r)).replaceWith(
                                              $(a.data).find("#".concat(r))
                                          );
                                      }),
                                      $(".report-chart-content").length &&
                                          ($(".report-chart-content").html(
                                              a.data.html
                                          ),
                    ...
                    a.on("apply.daterangepicker", function (t, e) {
                        ...
                        n || (n = "__from__ - __to__");
                        var o = n
                            .replace("__from__", e.startDate.format(r))
                            .replace("__to__", e.endDate.format(r));
                        a.find("span").text(o);
                    });
            }
        });

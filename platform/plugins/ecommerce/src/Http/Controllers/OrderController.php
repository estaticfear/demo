...
use Cmat\Ecommerce\Events\OrderConfirmedEvent;
use Cmat\Ecommerce\Events\OrderCreated;
use Cmat\Ecommerce\Events\ProductQuantityUpdatedEvent;
use Cmat\Ecommerce\Facades\DiscountFacade;
use Cmat\Ecommerce\Http\Requests\AddressRequest;
use Cmat\Ecommerce\Http\Requests\ApplyCouponRequest;
use Cmat\Ecommerce\Http\Requests\CreateOrderRequest;
use Cmat\Ecommerce\Http\Requests\CreateShipmentRequest;
use Cmat\Ecommerce\Http\Requests\RefundRequest;
use Cmat\Ecommerce\Http\Requests\UpdateOrderRequest;
use Cmat\Ecommerce\Http\Resources\CartItemResource;
use Cmat\Ecommerce\Http\Resources\OrderAddressResource;
...
use Cmat\Ecommerce\Services\HandleApplyPromotionsService;
use Cmat\Ecommerce\Services\HandleShippingFeeService;
use Cmat\Ecommerce\Tables\OrderIncompleteTable;
use Cmat\Ecommerce\Tables\OrderTable;
use Cmat\Payment\Enums\PaymentMethodEnum;
use Cmat\Payment\Enums\PaymentStatusEnum;
use Cmat\Payment\Repositories\Interfaces\PaymentInterface;
use Carbon\Carbon;
use Cart;
use EcommerceHelper;
use EmailHandler;
    ...
    protected function getDataBeforeCreateOrder(Request $request): array
    {
        ...
        foreach ($inputProducts as $inputProduct) {
            ...
            $options = [
                ...
                'total_merit_qty' => Arr::get($inputProduct, 'total_merit_qty') ?: 0,
            ];

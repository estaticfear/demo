    ...
    <div>
        ...
        <div class="row" v-if="earningSales.length">
            <div class="col-12">
                <ul>
                    <li
                        v-for="earningSale in earningSales"
                        v-bind:key="earningSale.text"
                    >
                        <i
                            class="fas fa-circle"
                            v-bind:style="{ color: earningSale.color }"
                        ></i>
                        {{ earningSale.text }}
                    </li>
                </ul>
                ...
                axios.get(this.url).then((res) => {
                    if (res.data.error) {
                        ...
                        this.chart = new ApexCharts(
                            this.$el.querySelector(".sales-reports-chart"),
                            {
                                ...
                                noData: {
                                    text: CmatVariables.languages.tables
                                        .no_data,
                                },
                            }
                        );

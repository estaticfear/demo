                            ...
                            <div class="table-wrap">
                                <table class="table-normal table-none-border table-color-gray-text text-end">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="color-subtext">
                                                {{ __('order.promotion_discount_amount') }}
                                            </td>
                                            <td>
                                                <div>
                                                    <span
                                                    ...
                                                    <span
                                                        class="fw-bold"
                                                        :class="{
                                                            'text-success': child_promotion_amount,
                                                        }"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <span
                                                        :class="{
                                                            'text-success fw-bold': child_discount_amount,
                                                        }"
                                                        >{{ child_discount_amount_label }}</span
                                                    >
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    ...
                                                    <span
                                                        :class="{
                                                            'fw-bold': child_shipping_amount,
                                                        }"
                                                        >{{ child_shipping_amount_label }}</span
                                                    >
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="next-card-section">
                        <ul class="ws-nm">
                            ...
                            <li class="text-infor-subdued mt15">
                                ...
                                <div>
                                    {{ child_customer_address.city_name }}
                                </div>
                                <div>
                                    {{ child_customer_address.state_name }}
                                </div>
                                <div>
                                    {{ child_customer_address.country_name }}
                                </div>
                                <div v-if="zip_code_enabled">
                            ...
                            <div class="flexbox-auto-left">
                                <div class="flexbox-input-group">
                                    ...
                                    <button
                                        ...
                                        :class="{
                                            active: discount_type === 'percentage',
                                        }"
                                        @click="changeDiscountType($event)"
                                    >
                                        %</button
                    ...
                    <div class="ui-banner ui-banner--status-info">
                        ...
                        <div class="ui-banner__content">
                            <h2 class="ui-banner__title">
                                {{ __('order.how_to_select_configured_shipping') }}
                            </h2>
                            <div class="ws-nm">
                                {{
                                    __(
    ...
    methods: {
        ...
        selectProductVariant: function (product, refOptions) {
            ...
            if (_.isEmpty(product) && product.is_out_of_stock) {
                Cmat.showError(context.__('order.cant_select_out_of_stock_product'));
                return false;
            }

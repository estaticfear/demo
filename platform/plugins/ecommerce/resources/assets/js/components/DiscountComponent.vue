            ...
            <div class="wrapper-content">
                <div class="pd-all-20 ws-nm">
                    <label class="title-product-main text-no-bold">
                        <span v-if="!is_promotion">{{
                            __("discount.create_coupon_code")
                        }}</span>
                        <span v-if="is_promotion">{{
                            __("discount.create_discount_promotion")
                        }}</span>
                    </label>
                    <a
                        href="#"
                ...
                <div class="pd-all-20 border-top-color">
                    <label
                        ...
                        >{{ __("discount.select_type_of_discount") }}</label
                    >
                ...
                <div class="pd-all-20 border-top-color">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <option value="group-products">
                                        {{ __("discount.product_collection") }}
                                    </option>
                                    ...
                                    <option value="product-variant">
                                        {{ __("discount.variant") }}
                                    </option>
                                    <option
                                        value="once-per-customer"
                                        v-if="
                                            type_option !== 'same-price' &&
                                            type == 'coupon'
                                        "
                                    >
                    ...
                    >
                        <input
                            type="hidden"
                            v-model="selected_variant_ids"
                            name="variants"
                        />
                        <div class="mt20">
                            <label class="text-title-field"
                                >{{ __("discount.selected_products") }}:</label
                            >
                        </div>
                    ...
                    <div
                        class="clearfix"
                        v-if="
                            selected_customers.length && target === 'customer'
                        "
                    >
                        <input
                            type="hidden"
                            v-model="selected_customer_ids"
                            name="customers"
                        />
                        <div class="mt20">
                            <label class="text-title-field"
                                >{{ __("discount.selected_customers") }}:</label
                            >
                        </div>
                        <div class="table-wrapper p-none mt10 mb20 ps-relative">
                            <table class="table-normal">
    ...
    methods: {
        ...
        handleChangeTypeOption: function () {
            ...
            switch (context.type_option) {
                ...
                case "percentage":
                    ...
                    break;
                case "shipping":
                    context.value_label = context.__(
                        "discount.when_shipping_fee_less_than"
                    );
                    break;
                case "same-price":
        ...
        loadListProductsForSearch: function (
            ...
            $(".textbox-advancesearch")
                ...
                .removeClass("hidden");
            if (
                _.isEmpty(context.variants.data) ||
                _.isEmpty(context.products.data) ||
                force
            ) {
        ...
        handleSearchProduct: function (include_variation = 1, value) {
            if (value !== this.product_keyword) {
                ...
                setTimeout(() => {
                    context.loadListProductsForSearch(
                        include_variation,
                        1,
                        true
                    );
                ...
                axios
                    ...
                    .then((res) => {
                        ...
                        if (!_.isEmpty(res.data.data)) {
                            context.product_collection_id = _.first(
                                res.data.data
                            ).id;
                        }
                        context.loading = false;
        ...
        handleSelectVariants: function (productVariant, variation) {
            if (!_.includes(this.selected_variant_ids, variation.product_id)) {
                ...
                variantItem.product_link = route(
                    "products.edit",

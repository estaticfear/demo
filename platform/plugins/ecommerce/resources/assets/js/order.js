class OrderAdminManagement {
    init() {
        ...
        $(document).on(
            ...
            (event) => {
                event.preventDefault();
                $("#confirm-resend-confirmation-email-button").data(
                    "action",
            ...
            (event) => {
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        ...
                        _self.removeClass("button-loading");
                        $("#resend-order-confirmation-email-modal").modal(
                            "hide"
                        );
                    },
                    error: (res) => {
        ...
        $(document).on("click", ".btn-cancel-shipment", (event) => {
            event.preventDefault();
            $("#confirm-cancel-shipment-button").data(
                "action",
                $(event.currentTarget).data("action")
            );
            ...
            $.ajax({
                ...
                success: (res) => {
                    if (!res.error) {
                        ...
                        $("#order-history-wrapper").load(
                            window.location.href + " #order-history-wrapper > *"
                        );
                ...
                $.ajax({
                    ...
                    success: (res) => {
                        if (!res.error) {
                            ...
                            $(".text-infor-subdued.shipping-address-info").html(
                                res.data.detail
                            );
                            let $formBody = $(".shipment-create-wrap");
                            Cmat.blockUI({

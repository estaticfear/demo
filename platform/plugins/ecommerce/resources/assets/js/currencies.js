    ...
    exportData() {
        ...
        $(".swatches-container .swatches-list li").each((index, item) => {
            ...
            data.push({
                id: $current.data("id"),
                is_default: $current
                    .find("[data-type=is_default] input[type=radio]")
                    .is(":checked")
                    ? 1
                    : 0,
                order: $current.index(),
                ...
                exchange_rate: $current
                    .find("[data-type=exchange_rate] input")
                    .val(),
                is_prefix_symbol: $current
                    .find("[data-type=is_prefix_symbol] select")
                    .val(),
            });
        });
        ...
        $("body")
            .on("submit", ".main-setting-form", () => {
                ...
                $("#deleted_currencies").val(
                    JSON.stringify(_self.deletedItems)
                );
            })

    ...
    init() {
        ...
        $(".disable-payment-item")
            ...
            .on("click", (event) => {
                ...
                $("#confirm-disable-payment-method-button").on(
                    "click",
                    (event) => {
                        event.preventDefault();
                        ...
                        $.ajax({
                            type: "POST",
                            cache: false,
                            url: $("div[data-disable-payment-url]").data(
                                "disable-payment-url"
                            ),
                            data: {
                                type: _self
                            ...
                            success: (res) => {
                                if (!res.error) {
                                    _self
                                        .closest("tbody")
                                        .find(".payment-name-label-group")
                                        .addClass("hidden");
                                    _self
                                        .closest("tbody")
                                        .find(".edit-payment-item-btn-trigger")
                                        .addClass("hidden");
                                    _self
                                        .closest("tbody")
                                        .find(".save-payment-item-btn-trigger")
                                        .removeClass("hidden");
                                    _self
                                        .closest("tbody")
                                        .find(".btn-text-trigger-update")
                                        .addClass("hidden");
                                    _self
                                        .closest("tbody")
                                        .find(".btn-text-trigger-save")
                                        .removeClass("hidden");
        ...
        $(".save-payment-item")
            ...
            .on("click", (event) => {
                ...
                $.ajax({
                    type: "POST",
                    cache: false,
                    url: $("div[data-update-payment-url]").data(
                        "update-payment-url"
                    ),

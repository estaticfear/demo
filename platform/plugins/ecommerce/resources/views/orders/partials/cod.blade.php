<li class="list-group-item">
    <input class="magic-radio js_payment_method" type="radio" name="payment_method" id="payment_cod"
           @if (PaymentMethods::getSelectingMethod() == \Cmat\Payment\Enums\PaymentMethodEnum::COD) checked @endif
    ...
    <div class="payment_cod_wrap payment_collapse_wrap collapse @if (PaymentMethods::getSelectingMethod() == \Cmat\Payment\Enums\PaymentMethodEnum::COD) show @endif" style="padding: 15px 0;">

<div class="shipment-info-panel hide-print">
    ...
    @if ($shipment->status != \Cmat\Ecommerce\Enums\ShippingStatusEnum::CANCELED)
        <div class="panel-heading order-bottom shipment-actions-wrapper">
            <div class="flexbox-grid-default">
                <div class="flexbox-content">
                    @if (in_array($shipment->status, [\Cmat\Ecommerce\Enums\ShippingStatusEnum::NOT_APPROVED, \Cmat\Ecommerce\Enums\ShippingStatusEnum::APPROVED]))

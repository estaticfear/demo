...
<div class="next-form-section">
    <div class="next-form-grid">
        <div class="next-form-grid-cell">
            ...
            <div class="table-wrap p-none">
                <table class="refund-totals">
                    ...
                    <tr>
                        ...
                        <td class="text-end quantity text-no-bold">
                            @if (! is_plugin_active('payment') || $order->payment->status == \Cmat\Payment\Enums\PaymentStatusEnum::PENDING)
            ...
            @if (is_plugin_active('payment') && $order->payment->status !== \Cmat\Payment\Enums\PaymentStatusEnum::PENDING && ($order->payment->amount - $order->payment->refunded_amount) > 0)

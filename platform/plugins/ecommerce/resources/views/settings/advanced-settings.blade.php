                    ...
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div id="tax-settings" class="mb-4 border rounded-top rounded-bottom p-3 bg-light @if (!EcommerceHelper::isTaxEnabled()) d-none @endif">
                            <div class="form-group mb-3">
                                ...
                                {!! Form::customSelect('default_tax_rate', [0 => trans('plugins/ecommerce::tax.select_tax')] + app(\Cmat\Ecommerce\Repositories\Interfaces\TaxInterface::class)->pluck('title', 'id'), get_ecommerce_setting('default_tax_rate')) !!}
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-group form-group-no-margin">
                                <div class="multi-choices-widget list-item-checkbox">
                                    <ul>
                                        @foreach (\Cmat\Base\Supports\Helper::countries() as $key => $item)
                                            <li>
                                                <input type="checkbox"

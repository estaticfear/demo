...
{{-- <div class="form-group stock-status-wrapper @if (old('with_storehouse_management', $product ? $product->with_storehouse_management : ($originalProduct->with_storehouse_management ?? 0)) == 1) hidden @endif">
    ...
    {!! Form::customSelect('stock_status', \Cmat\Ecommerce\Enums\StockStatusEnum::labels(), $product ? $product->stock_status : null) !!}
</div> --}}

{{-- <hr/> --}}

{{-- @if (!EcommerceHelper::isEnabledSupportDigitalProducts() ||
    (!$product && !$originalProduct && request()->input('product_type') != Cmat\Ecommerce\Enums\ProductTypeEnum::DIGITAL) ||

...
<ul class="wc_status_list">
    ...
    <li class="out-of-stock">
        <a href="{{ route('products.index') }}?filter_table_id=cmat-ecommerce-tables-product-table&class=Cmat%5CEcommerce%5CTables%5CProductTable&filter_columns%5B%5D=stock_status&filter_operators%5B%5D=%3D&filter_values%5B%5D=out_of_stock">

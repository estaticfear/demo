    ...
    <div class="max-width-1036">
        <div class="flexbox-grid">
            <div class="flexbox-content">
                ...
                @if($returnRequest->return_status != \Cmat\Ecommerce\Enums\OrderReturnStatusEnum::COMPLETED || $returnRequest->return_status != \Cmat\Ecommerce\Enums\OrderReturnStatusEnum::CANCELED )
                    <div class="wrapper-content mb20">
                        ...
                        <div class="pd-all-10-20">
                            <form action="{{ route('order_returns.edit', $returnRequest->id) }}" method="POST">
                                ...
                                {!! Form::customSelect('return_status', \Cmat\Ecommerce\Enums\OrderReturnStatusEnum::labels(),$returnRequest->return_status, ['class'=> 'form-control']) !!}

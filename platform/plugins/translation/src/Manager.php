...
namespace Cmat\Translation;

use ArrayAccess;
use BaseHelper;
use Cmat\Base\Supports\PclZip as Zip;
use Cmat\Translation\Models\Translation;
use Exception;
...
class Manager
{
    ...
    public function getRemoteAvailableLocales(): array
    {
        ...
        try {
            $info = $client->request('GET', 'https://api.github.com/repos/cmat/translations/git/trees/master', [
                'headers' => [
    ...
    {
        $repository = 'https://github.com/cmat/translations';
